...
class ConciseLinearRegressionModel(torch.nn.Module):
    def __init__(
        self,
        features_dim: int,
        learning_rate: float,
...
class Trainer:
    def __init__(
        ...
        model: ConciseLinearRegressionModel,
    ) -> None:
...
def main():
    ...
    model = ConciseLinearRegressionModel(features_dim=len(w), learning_rate=0.01)
