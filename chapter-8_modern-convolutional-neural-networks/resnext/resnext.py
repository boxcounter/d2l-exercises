...
def main(
    ...
    plotter = MetricsPlotter(
        title=f"FashionMNIST Classifier ({ResNeXt18.__name__})", filename="metrics.png")
...
if __name__ == "__main__":
    ...
    # Final output:
    # epoch #9, train_loss = 0.106, validate_loss = 0.305, accuracy = 89.3%
    # elapsed time: 138.7 seconds
    # done!
